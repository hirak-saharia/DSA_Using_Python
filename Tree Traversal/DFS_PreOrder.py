# Write a function called dfs_pre_order that performs a Depth-First Search traversal on a binary tree using the Pre-order approach.
...
class BinarySearchTree:
    ...
    def dfs_pre_order(self):
        ...
        # start the pre-order trasversal from the root of the tree
        traverse(self.root)
